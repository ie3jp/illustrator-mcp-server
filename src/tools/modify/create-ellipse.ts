...
export const jsxCode = inlineTemplateText('src/tools/modify/create-ellipse.jsx', {
...
export function register(server: ToolRegistry): void {
  server.registerTool(
    'create_ellipse',
    {
      ...
      inputSchema: {
        x: v.number().describe('Bounding box top-left X coordinate'),
        y: v.number().describe('Bounding box top-left Y coordinate'),
