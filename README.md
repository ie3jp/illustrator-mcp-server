...
> **Important:** AI can make mistakes. The output generated by this tool is not guaranteed to be correct. Humans are ultimately responsible for all results, and **final verification of submission data must always be performed by a human**. Do not blindly trust AI-generated output — always review before use in production.
